...
timeNow5 = millis(); // Control de tiempo para esperas no bloqueantes
  ...
  if (timeNow5 - timeLast5 > wait5) { 
    ...
    dtostrf(t, 1, 2, tempString);    // Función nativa de leguaje AVR; convierte un arreglo de caracteres en una var String
    dtostrf(h, 1, 2, humeString);    // Función nativa de leguaje AVR; convierte un arreglo de caracteres en una var String
